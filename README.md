...
1.I decided to put a search bar on the super hero tab as well since it's a usefull tool
2.
...
<img src='https://image.ibb.co/iNK6Ye/flix_Layout_Walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
# Lab 5 - Flix with models

**Flix with models** is a movies app displaying box office and top rental DVDs using [The Movie Database API](http://docs.themoviedb.apiary.io/#).
